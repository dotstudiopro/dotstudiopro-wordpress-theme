...
<div id="primary" class="content-area container center-page-content">
    <main id="main" class="site-main" role="main">

        <section class="error-404 not-found text-center pt-5 row pb-5">
            <div class="align-middle col-md-12">
                ...
                <div class="page-content">
                    ...
                    <a class="btn btn-secondary btn-ds-secondary" href="/">Take Me Home</a>
                </div><!-- .page-content -->
            </div>
        </section><!-- .error-404 -->
