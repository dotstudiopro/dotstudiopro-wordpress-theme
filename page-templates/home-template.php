                        ...
                        <div class="slick-wrapper <?php echo $class ?>">
                            ...
                            <?php foreach ($channels as $channel) { ?>
                                <div class="slide">
                                    ...
                                    <?php
                                    $title = ($dsp_theme_options['opt-title-trim-word'] != 0) ? mb_strimwidth($channel['title'], 0, $dsp_theme_options['opt-title-trim-word'], "...") : $channel['title'];
                                    $description = ($dsp_theme_options['opt-description-trim-word'] != 0) ? mb_strimwidth($channel['description'], 0, $dsp_theme_options['opt-description-trim-word'], '...') : $channel['description'];
                                    ?>
