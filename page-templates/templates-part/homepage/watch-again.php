<?php include(locate_template('page-templates/templates-processing/watch-again-processing.php')); ?>
<div class="col-sm-12 no-gutters pt-5">
    ...
    <div class="slick-wrapper watch-again <?php echo $class .' '. $slide_text_class ?>">
        <?php
        $c = 0;
        foreach ($final_watch_again_data['watch_again_data'] as $data):
            ?>
            <div class="slide">
                <div class="slide_image tooltippp clearfix" data-tooltip-content="#<?php echo 'channel_tooltip_content_' . $c; ?>">
                    <div class="hover ehover<?php echo $dsp_theme_options['opt-img-hover']; ?>">
                        <?php if(isset($data['image_attributes_sizes']) && isset($data['image_attributes_srcset'])) :?>
                            <img src="<?php echo $final_watch_again_data['default_image']; ?>" class="lazy w-100" data-src="<?php echo $data['banner']; ?>" title="<?php echo $data['title']; ?>" alt="<?php echo $data['title']; ?>" srcset="<?php echo $data['image_attributes_srcset']; ?>" sizes="<?php echo $data['image_attributes_sizes']; ?>">
                        <?php else : ?>   
                            <img src="<?php echo $final_watch_again_data['default_image']; ?>" class="lazy w-100" data-src="<?php echo $data['banner']; ?>" title="<?php echo $data['title']; ?>" alt="<?php echo $data['title']; ?>">
                        <?php endif; ?>
                        <div class="overlay">
