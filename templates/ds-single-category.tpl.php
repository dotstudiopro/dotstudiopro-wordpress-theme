			...
			<li class='gridder-list light-theme-shadow' data-griddercontent='#<?php echo $slug ?>'>
	    		...
	    		<div id='<?php echo $slug ?>' class='gridder-content'>
	    			<div class='og-expander-inner light-theme-shadow clearfix'>
			    		<a class='og-fullimg' href='<?php echo home_url("channels/$slug/") ?>'><object class='channel-poster animated fadeIn' data='<?php echo !empty($thumb_id) ? $thumb_id : $poster ?>/1080/610' type='image/png'></object></a>
