...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => __('Here you can set number of characters shown in category titles in the carousel', 'dotstudio-pro'),
            'default' => '5',
            'min' => '0',
            'step' => '1',
            'max' => '30',
        ...
        array(
            ...
            'desc' => __('Here you can set number of characters shown in category descriptions in the carousel', 'dotstudio-pro'),
            'default' => '10',
            'min' => '0',
            'step' => '1',
            'max' => '50',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'spinner',
            'title' => __('Trim title on carousel', 'dotstudio-pro'),
            'desc' => __('Here you can set number of characters to be visible on channel title.', 'dotstudio-pro'),
            'default' => '5',
            'min' => '0',
            'step' => '1',
            'max' => '30',
        ...
        array(
            ...
            'type' => 'spinner',
            'title' => __('Trim description on carousel', 'dotstudio-pro'),
            'desc' => __('Here you can set number of characters to be visible on channel description.', 'dotstudio-pro'),
            'default' => '10',
            'min' => '0',
            'step' => '1',
            'max' => '50',
